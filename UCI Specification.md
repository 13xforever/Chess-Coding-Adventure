...
| GUI                                                                                                                                                                                                     | Engine                                                                                                                                                                           |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| tell the engine to switch to UCI mode<br/><pre>uci</pre>                                                                                                                                                |                                                                                                                                                                                  |
|                                                                                                                                                                                                         | engine identify<br/><pre>id name Shredder<br/>id author Stefan MK</pre>                                                                                                          |
| engine sends the options it can change<br/>the engine can change the hash size from 1 to 128 MB<br/><pre>option name Hash type spin default 1 min 1 max 128</pre>                                       |                                                                                                                                                                                  |
|                                                                                                                                                                                                         | the engine supports Nalimov endgame tablebases<pre>option name NalimovPath type string default &lt;empty&gt;<br/>option name NalimovCache type spin default 1 min 1 max 32</pre> |
